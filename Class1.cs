...
[assembly: ExtensionApplication(typeof(Lab8_Complete.Hello))]

namespace Lab8_Complete
{
    public class Hello : IExtensionApplication
    {
        ...
        public static void SendACommandToAutoCAD()
        {
            ...
            if (acDoc == null)
            {
                System.Console.WriteLine("acDoc is null!");
            }

            OpenFileDialog ofd = new OpenFileDialog("Select a file using an OpenFileDialog", null, "dwg;*", "SelectFileTest", OpenFileDialog.OpenFileDialogFlags.AllowAnyExtension);
            ...
            //AcAp.Application.DocumentManager.Open(fileName, false[true]);
